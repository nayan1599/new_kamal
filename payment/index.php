...
$stmt = $pdo->query("SELECT * FROM kisti_payments ORDER BY payment_date DESC lIMIT 10");
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-end fw-bold text-success">৳
                                <?= bn_number(number_format($row['amount'], 2)) ?></td>
                            ...
                            <td>
                                ...
                                <span class="badge bg-<?= $method == 'cash' ? 'success' : 'info' ?>"> <?= $methodText ?>
                                </span>
                            </td>
                            <td>
                            ...
                            <td class="text-center">
                                ...
                                <a href="index.php?page=payment/view&id=<?= $row['id'] ?>"
                                    class="btn btn-sm btn-success">
                                    View
                                </a>

                                <a href="index.php?page=payment/edit&id=<?= $row['id'] ?>"
