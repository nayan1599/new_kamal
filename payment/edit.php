                ...
                <div class="card-body">
                    <form method="POST" action="index.php?page=sql/update_payment">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select name="payment_method" class="form-select">
                                        <option value="cash" <?= ($row['payment_method']=='cash')?'selected':'' ?>>Cash
                                        </option>
                                        <option value="bkash" <?= ($row['payment_method']=='bkash')?'selected':'' ?>>
                                            Bkash</option>
                                        <option value="nagad" <?= ($row['payment_method']=='nagad')?'selected':'' ?>>
                                            Nagad</option>
                                        <option value="bank_transfer"
                                            <?= ($row['payment_method']=='bank_transfer')?'selected':'' ?>>Bank</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            ...
                            <a href="index.php?page=payment/index" class="btn btn-success">পিছে জান </a>
                        </div>
                            </div>
                                   <div class="col-md-6">
                                    <div class="text-end">
