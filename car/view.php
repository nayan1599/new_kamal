...
if (!isset($_GET['car_number']) || empty($_GET['car_number'])) {
    die("<h3 style='text-align:center;margin-top:3rem;color:#dc3545;'>গাড়ির নম্বর দেয়া হয়নি!</h3>");
}
...
if (empty($payments)) {
    die("<h3 style='text-align:center;margin-top:3rem;color:#dc3545;'>এই গাড়ির কোনো কিস্তি পাওয়া যায়নি!</h3>");
}
...
// 👉 যদি negative হয় (মানে শেষ হয়ে গেছে)
