    ...
    <form method="POST" action="index.php?page=sql/car_update">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <input type="number" name="total_price" class="form-control" value="<?= $data['total_price'] ?>">
            </div>

            <div class="col-md-6">
                <label>পেইড</label>
                <input type="number" name="paid_amount" class="form-control" value="<?= $data['paid_amount'] ?>">
            </div>

            <div class="col-md-6">
                <label>মোট কিস্তি</label>
                <input type="number" name="total_kisti" class="form-control" value="<?= $data['total_kisti'] ?>">
            </div>

            <div class="col-md-6">
                <label>মাসিক কিস্তি</label>
                <input type="number" name="monthly_kisti" class="form-control" value="<?= $data['monthly_kisti'] ?>">
            </div>
            ...
            <div class="col-md-6">
                ...
                <select name="status" class="form-select" required>
                    ...
                    <option value="completed"
                        <?= (isset($data['status']) && $data['status']=='completed') ? 'selected' : '' ?>>
                        সম্পূর্ণ
                    </option>
