            ...
            <form class="needs-validation" novalidate method="POST" action="">
                ...
                <div class="row g-3">
                    <div class="col-md-6">
                        ...
                        <input class="form-control" type="text" name="customer_name" placeholder="কাস্টমারের পুরো নাম" required>
                    ...
                    <div class="col-12">
                        ...
                        <textarea name="address" class="form-control" rows="3" placeholder="কাস্টমারের পুরো ঠিকানা"></textarea>
                    </div>
                </div>
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" type="text" name="car_number" placeholder="গাড়ির নম্বর (যেমন: ঢাকা মেট্রো-গ-১২৩৪)">
                    </div>
                    <!-- <div class="col-md-6">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input class="form-control" type="number" name="monthly_kisti" step="0.01" placeholder="মাসিক কিস্তির পরিমাণ" required>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="mt-4">
                    ...
                    <textarea name="note" class="form-control" rows="4" placeholder="অতিরিক্ত তথ্য বা নোট..."></textarea>
                </div>
